...
import com.zzy.springboot.constant.UserConstant;
import com.zzy.springboot.exception.BusinessException;
import com.zzy.springboot.model.dto.userinterfaceInfo.UserInterfaceInfoAddRequest;
import com.zzy.springboot.model.dto.userinterfaceInfo.UserInterfaceInfoQueryRequest;
import com.zzy.springboot.model.dto.userinterfaceInfo.UserInterfaceInfoUpdateRequest;
...
public class UserInterfaceInfoController {
    ...
    // public BaseResponse<Boolean> onlineUserInterfaceInfoByPage(@RequestBody IdRequest idRequest, HttpServletRequest request) {
    ...
    // @PostMapping("/offline")
    // @AuthCheck(mustRole = "admin")
    // public BaseResponse<Boolean> offlineUserInterfaceInfoByPage(@RequestBody IdRequest idRequest, HttpServletRequest request) {
    //     if (idRequest == null || idRequest.getId() <=0){
    //         throw new BusinessException(ErrorCode.NOT_FOUND_ERROR,"请求数据不存在");
    //     }
    //     Long id = idRequest.getId();
